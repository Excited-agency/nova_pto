-- ============================================================
-- Migration: Lock employee profile row during approval
-- Prevents race condition where employee is deactivated while
-- their time-off request is being approved concurrently.
-- ============================================================

-- Fix approve_time_off_request: lock profiles row
...
-- Fix approve_time_off_request_bot: lock profiles row
